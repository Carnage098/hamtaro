# Hamtaro — Format Araignée v4.2 (alias images)

La v4.2 conserve le pool corrigé à **122 cartes** et ajoute un système d'**alias d'images** pour résoudre beaucoup plus de cartes dans la galerie.
...
git status
git add -A
git commit -m "Ajout alias images Format Araignée v4.2"
