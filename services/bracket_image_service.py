...
class BracketImageService:
    ...
    def _round_title(
        ...
        """Retourne un intitulé de ronde lisible et sans accent."""
    ...
    def _fit_text(
        ...
        """Coupe un texte uniquement lorsqu'il ne peut plus être réduit."""
    ...
    def _fit_font_and_text(
        ...
        *,
        ...
        Les pseudos longs conservent ainsi davantage de caractères tout en
        restant lisibles dans les cartes compactes des grands brackets.
        """
    ...
    def _draw_background_effects(
        ...
        """
        Dessine une ambiance rouge/bleue plus équilibrée.

        Les opacités séparées du thème permettent d'alléger la moitié rouge
        sans affadir la moitié bleue. Le dégradé est construit sur une ligne
        puis étiré afin d'éviter une boucle coûteuse sur chaque pixel.
        """
        ...
        gradient_values: list[tuple[int, int, int, int]] = []
        ...
        gradient_strip.putdata(
            gradient_values
        )

        gradient = gradient_strip.resize(
            (
                width,
                content_height,
            ),
        ...
        gradient_layer.alpha_composite(
            gradient,
            (
                0,
                header_height,
        ...
        left_glow_color = getattr(
            self.theme,
            "left_background_glow",
            self.RED,
        )

        right_glow_color = getattr(
            self.theme,
            "right_background_glow",
            self.BLUE,
        )
    ...
    def _draw_hamster_fallback(
        ...
        """
        Dessine une mascotte hamster détaillée lorsque l'asset est absent.

        Le dessin est réalisé en haute résolution puis réduit afin de garder
        des contours propres dans le header comme dans la carte champion.
        """
        ...
        for eye_center_x in (
            ...
            draw.ellipse(
                (
                    point(eye_center_x - 0.015),
                    point(0.365),
                    point(eye_center_x + 0.008),
                    point(0.395),
                ),
                fill=(
                    255,
    ...
    def _draw_glowing_polyline(
        ...
        """Dessine une ligne lumineuse à partir d'une suite de points."""
    ...
    def _draw_glowing_segments(
        ...
        """
        Dessine plusieurs segments dans les mêmes calques.

        Cette méthode évite la superposition de plusieurs halos au milieu
        des embranchements et produit des connecteurs plus réguliers.
        """
    ...
    def _draw_connectors(
        ...
        """
        Relie les cartes avec un embranchement unique par match parent.

        Les deux enfants rejoignent un même axe vertical avant d'entrer dans
        la carte suivante. Les lignes ne se doublent donc plus au centre.
        """
        ...
        for child_round in range(
            ...
            for side in (
                ...
                for parent_index, parent_position in enumerate(
                    ...
                    for child_source_x, child_center_y in child_centers:
                        segments.append(
                            (
                                (
                                    child_source_x,
                    ...
                    child_y_values = [
                        center_y
                        for _, center_y in child_centers
                    ]
    ...
    def _draw_player_row(
        ...
        """
        Dessine une ligne de joueur lisible même dans un bracket compact.

        La police du pseudo diminue progressivement avant que le texte ne soit
        coupé. Les scores neutres, gagnants et perdants ont chacun leur fond.
        """
        ...
        elif result_known and player.score != "BYE":
            score_background = getattr(
                self.theme,
        ...
        seed_font, seed_text = self._fit_font_and_text(
            draw,
            seed_text,
        ...
        name_font, display_name = self._fit_font_and_text(
            draw,
            player.name,
        ...
        score_font, score_text = self._fit_font_and_text(
            draw,
            player.score,
