# Hamtaro — Format Araignée v4.1 (pool corrigé)

La v4.1 conserve la galerie visuelle et retire les 8 cartes **Scorpion Noir** du pool officiel. Le pool Araignée contient désormais **122 cartes** sur `/formats/araignee`.
