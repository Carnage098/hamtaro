...
HALLOWEEN_CARD_CATALOG: dict[str, dict[str, Any]] = {
    ...
    "Archfiend": {
        ...
        "note": (
            "Le catalogue ne se limite pas aux noms contenant Archfiend : le tag officiel "
            "de l'archétype est utilisé et les anciennes cartes traitées comme Archfiend sont ajoutées en fallback."
        ),
    },
    ...
    "Yubel": {
        ...
        "core_title": "Monstres",
        "note": "Yubel est séparé en Monstres / Extra Deck / Support / Related, conformément au catalogue de référence.",
    },
    ...
    "Azamina": {
        ...
        "note": (
            "Le tag officiel Azamina fournit le cœur du deck. Les cartes Sinful Spoils / Diabellstar "
            "sans Azamina dans leur nom sont rangées dans Staples compatibles."
        ),
    },
    "K9": {"archetypes": ["K9"]},
    "Snake-Eye": {
        ...
        "staples": ["Bonfire"],
        "note": "Catalogue Snake-Eye explicite pour éviter qu'une partie de l'archétype disparaisse si le tag API est incomplet.",
    },
    "Phantom Knights": {
        "core_exact": [
        ...
        "note": "Liste explicite : Phantom Knights ne dépend plus d'une requête d'archétype qui pouvait ne rien renvoyer.",
    },
    ...
    "Call of the Haunted / Pumpking": {
        ...
        "note": (
            "Package Call of the Haunted / Pumpking enrichi avec le support Maze of Muertos, "
            "les deux Xyz dédiés et les anciennes cartes de Bonz."
        ),
    },
    ...
    "Eyes Restrict / Relinquished": {
        ...
        "exclude_exact": ["Nightmare-Eyes Restrict"],
        "note": "Catalogue TCG explicite : Nightmare-Eyes Restrict est exclu tant qu'il reste OCG-only.",
    },
    ...
    "Spirit Message": {
        ...
        "note": "Spirit Message inclut davantage de supports Bakura / Destiny Board et sépare les staples Halloween.",
    },
...
class HalloweenFormatService:
    def public_data(self) -> dict[str, Any]:
        ...
        return {
            ...
            "format_version": "3.0",
            "description": (
                "Format horrifique Hamtaro avec whitelist enrichie, catalogues explicites, staples séparées, "
                "tier list locale modulable et banlist Halloween spéciale."
            ),
            "meta_left": "Whitelist Halloween V3",
    ...
    def banlist_text(self) -> str:
        lines = [
            "FORMAT HALLOWEEN V3 - EXCEPTIONS DE BANLIST",
